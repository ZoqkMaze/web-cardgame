...
Althought it might change in future, the package ~~and the api~~ (it will be refactored to use sockets) are basicly finished. Just the web frontend needs huge improvements.



## witches package
First, you need to install the local package. Therefore, run `pip install -e package/`. Now, the package should be available.
